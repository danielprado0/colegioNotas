...
public class login extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jtxtuser, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if((this.jtxtuser.getText().isEmpty()!=true) && (this.jtxtpass.getText().isEmpty()!=true)){
            try {
                String user = this.jtxtuser.getText();
                String pass = sha1.SHA1(this.jtxtpass.getText());
                ResultSet consul = conec.consul("Select count(*) from usuario where usuario = '" +user + "' and password='"+pass +"';" );
                if (consul.next()){
                    if(consul.getInt(1) == 1){
                        this.dispose();
                        menu.main(null);
                    }else{
                        javax.swing.JOptionPane.showMessageDialog(rootPane, "Error No se ha podido iniciar sesión", "Error", 0);
                    }
                }else{
                    javax.swing.JOptionPane.showMessageDialog(rootPane, "Error No se ha podido iniciar sesión", "Error", 0);
                }
            ...
            javax.swing.JOptionPane.showMessageDialog(rootPane, "Debe llenar los campos", "Error", 2);
        }
